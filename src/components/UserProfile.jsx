            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 pt-6">
              <div className="overflow-hidden bg-white shadow sm:rounded-lg">
                <div className="px-4 py-5 sm:px-6">
                  <center>
                    <img className="h-40 w-55 rounded-full" src={`${URL}${user.image}`} alt="" />
                    <br></br>
                    <h3 className="text-lg font-medium leading-6 text-gray-900">{user.user_name} &nbsp;&nbsp;&nbsp;&nbsp;

                    </h3>
                  </center>
                  <p className="mt-1 max-w-2xl text-sm text-gray-500">Información de Usuario</p>
                </div>
                ...
                <div className="border-t border-gray-200">
                  <dl>
                    ...
                    <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                      <dt className="text-sm font-medium text-gray-500">Acerca de ti</dt>
                            ...
                            <div className="w-full">
                              <div key={blog.id} class="flex justify-between items-center m-8">
                                <div className="flex flex-row items-center">
                                  ...
                                  <img src={`${URL}${user.image}`} class="rounded-full" width="40" />
